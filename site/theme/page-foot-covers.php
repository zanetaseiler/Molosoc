	...
	<section class="molosoc-who-section" aria-label="<?php esc_attr_e( 'Who this is for', 'molosoc' ); ?>">
		<div class="molosoc-who-section__stage">
			...
			<div class="molosoc-who-cards">
				<a class="molosoc-who-card molosoc-who-card--1" href="<?php echo esc_url( home_url( '/foot-covers/moisture-lock-foot-cover/' ) ); ?>">
				...
				<a class="molosoc-who-card molosoc-who-card--2" href="<?php echo esc_url( home_url( '/foot-covers/moisture-lock-foot-cover/' ) ); ?>">
				...
				<a class="molosoc-who-card molosoc-who-card--3" href="<?php echo esc_url( home_url( '/foot-covers/moisture-lock-foot-cover/' ) ); ?>">
