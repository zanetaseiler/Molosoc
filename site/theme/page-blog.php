...
<main id="main">
	...
	<section class="molosoc-section molosoc-section--bg-cream molosoc-blog-intro">
		<div class="molosoc-section__inner">
			<p class="molosoc-eyebrow"><?php esc_html_e( 'Foot care, explored', 'molosoc' ); ?></p>
			<h1><?php esc_html_e( 'The Journal', 'molosoc' ); ?></h1>
			<p class="molosoc-section__lede">
				<?php esc_html_e( 'Eleven honest guides on cracked heels, ingrown toenails, calluses, and the routines that actually help — no filler, no fear-mongering.', 'molosoc' ); ?>
			</p>
		</div>
	</section>
