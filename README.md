...
- `automations/social/` — Meta (Facebook + Instagram) connection, CZ and EN separately. Currently a read-only connection test only — no posting or scheduling. See its README before adding secrets.
