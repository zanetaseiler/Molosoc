---
name: hero-breathing-zoom
description: Reusable ambient photo animation where an image inside an overflow-hidden frame slowly scales up and back down forever (100% to ~106%, ease-in-out, alternating), giving a still photo a subtle sense of life without ever looking like a hover-zoom or a one-time reveal. Continuous, not scroll-linked or hover-triggered. Use when a request wants a hero or feature photo to "breathe," feel gently alive, or have ambient/idle motion, on a static HTML/CSS/JS site, a WordPress theme, or a React/Next.js app.
---
